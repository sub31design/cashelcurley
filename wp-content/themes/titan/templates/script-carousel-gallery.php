...
?>
<?php $homeslides .= '{image : \''.$image_url[0].'\', thumb: \''.$small_image_url[0].'\', title: \'<div id="gallery_caption"><h2>'.strip_tags($photo->post_title).'</h2><br class="clear"/><div class="gallery_desc">'.strip_tags($photo->post_content).'</div></div>\'},'; ?>
<?php
	}
?>
