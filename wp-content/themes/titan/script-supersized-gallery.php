...
?>
<?php $homeslides .= '{image : \''.$image_url[0].'\', thumb: \''.$small_image_url[0].'\', title: \'<div id="gallery_caption"><h2>'.htmlentities($photo->post_title, ENT_QUOTES, "UTF-8").'</h2><br class="clear"/><div class="gallery_desc">'.$photo->post_content.'</div></div>\'},'; ?>
<?php
	}
?>
